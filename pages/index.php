         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item"><a href="#.html" class="nav-link">Sobre Nós</a></li>
                  <li class="nav-item cta"><a href="#.html" class="nav-link"><span>COMEÇAR!</span></a></li>
               </ul>
            </div>
         </div>
      </nav>
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  <p>
                     ...
                     <script>document.write(new Date().getFullYear());</script> | Report Deck
                     <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  </p>
               </div>
            </div>
