<?php
	...
	$fone = mysqli_real_escape_string($conn,$_POST['telefoneUsuario']);
	$nascimento = mysqli_real_escape_string($conn,$_POST['nctoUsuario']);
	$senha = mysqli_real_escape_string($conn,$_POST['senhaUsuario']);

	$cpf = $_SESSION['cpf'];

	$sql = "UPDATE Cidadao SET Genero = '".$genero."', Nome_completo = '".$nome."',Telefone = '".$fone."', Nascimento = '".$nascimento."', Email = '".$email."' WHERE Cidadao.CPF = '".$cpf."'";
